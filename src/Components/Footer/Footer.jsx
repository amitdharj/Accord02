        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex space-x-4 mt-6">
              <a href="https://www.facebook.com/" className="w-10 h-10 bg-white rounded border border-gray-300 flex items-center justify-center hover:bg-gray-50 transition-colors">
